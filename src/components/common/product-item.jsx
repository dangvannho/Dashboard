...
function productItem({ product, renderStars }) {
        ...
        <>
            ...
            >
                <div className="relative overflow-hidden rounded-xl mb-4">
                    ...
                    />
                    <button
                        className="absolute left-2 top-1/2 transform -translate-y-1/2 bg-white/80 p-2 rounded-full shadow-sm"
                        onClick={() => setImageIndex((prev) => (prev === 0 ? 1 : 0))}
                    >
                        <ChevronLeft size={16} />
                    </button>
                    <button
                        className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-white/80 p-2 rounded-full shadow-sm"
                        onClick={() => setImageIndex((prev) => (prev === 0 ? 1 : 0))}
                    >
                ...
                <div className="px-2">
                    <div className="flex justify-between items-start">
                        <h3 className=" text-[18px] font-bold leading-[20px] text-[#202224]">{product.name}</h3>
                        <button
                    ...
                    <div className="mt-2">
                        <p className="text-[16px] font-bold leading-[20px] text-[#4880FF]">{product.price}</p>
